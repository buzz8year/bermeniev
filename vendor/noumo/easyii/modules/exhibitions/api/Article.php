...
/**
 * Article module API
 * @package yii\easyii\modules\exhibitions\api
 *
 * @method static CategoryObject cat(mixed $id_slug) Get exhibition category by id or slug
 * @method static array tree() Get exhibition categories as tree
 * @method static array cats() Get exhibition categories as flat array
 * @method static array items(array $options = []) Get list of exhibitions as ArticleObject objects
 * @method static ArticleObject get(mixed $id_slug) Get exhibition object by id or slug
 * @method static mixed last(int $limit = 1) Get last exhibitions
...
class Article extends \yii\easyii\components\API
{
    ...
    public function api_last($limit = 1, $where = null)
    {
        ...
        $id_slug = end(array_reverse(Category::cats()))->category_id;
        ...
        $query = Item::find()->where(['or', 'category_id=:id_slug'], [':id_slug' => $id_slug])->with($with)->status(Item::STATUS_ON)->sortDate()->limit($limit);
