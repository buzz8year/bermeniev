<?php
namespace app\modules\biblio\models;
...
class News extends \yii\easyii\components\ActiveRecord
{
    ...
    {
        return [
            'title' => Yii::t('easyii', 'Year'),
            'text' => Yii::t('easyii', 'Book Annotation'),
            'short' => Yii::t('easyii/biblio', 'Book Title'),
    ...
    public function beforeSave($insert)
    {
        if (parent::beforeSave($insert)) {
            $settings = Yii::$app->getModule('admin')->activeModules['biblio']->settings;
