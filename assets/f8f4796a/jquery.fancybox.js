    ...
    n.extend(s, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                image: '<img class="fancybox-image" src="{href}" alt="" /><div class="share-wrap"><i class="photo-fb"><iframe src="https://www.facebook.com/plugins/share_button.php?href=http://www.bermeniev.com{href}&layout=icon_link&mobile_iframe=true&width=48&height=15&appId" width="48" height="15" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe></i></div>',
        ...
        showLoading: function() {
            var e, t;
            s.hideLoading(), e = n(s.opts.tpl.loading).click(s.cancel).appendTo("body"), r.bind("keydown.loading", function(e) {
        ...
        _setDimension: function() {
            var e, t, i, o, a, r, l, c, d, p, h, u, y, x, v, w = s.getViewport(),
                ...
                I = g(A[1] + A[3]),
                D = g(A[0] + A[2]);
            if (O.add(W).add(_).width("auto").height("auto").removeClass("fancybox-tmp"), e = g(W.outerWidth(!0) - W.width()), t = g(W.outerHeight(!0) - W.height()), i = I + e, o = D + t, a = f(T) ? (w.w - i) * g(T) / 100 : T, r = f(E) ? (w.h - o) * g(E) / 100 : E, "iframe" === S.type) {
            ...
            M && "auto" === j && r > E && u > T + e + M && (T += M), _.width(T).height(E), O.width(T + e), p = O.width(), h = O.height(), k = (p > u || h > y) && T > L && E > H, C = S.aspectRatio ? l > T && c > E && a > T && r > E : (l > T || c > E) && (a > T || r > E), n.extend(S, {
                dim: {
                    width: m(p),
                    height: m(h)
                },
            ...
            }), !x && S.autoHeight && E > H && R > E && !C && _.height("auto"), n(s.outer).on("swipeleft", function() {
                s.next()
            }), n(s.outer).on("swiperight", function() {
                s.prev()
            })
        },
        ...
        beforeShow: function(e, t) {
            ...
            }).addClass("fancybox-margin"), this.el.addClass("fancybox-margin"), this.scrollV = a.scrollTop(), this.scrollH = a.scrollLeft(), this.el.addClass("fancybox-lock"), a.scrollTop(this.scrollV).scrollLeft(this.scrollH), n("body").bind("touchmove.fb", function(e) {
                e.preventDefault()
            })), this.open(e)
        },
        onUpdate: function() {
        ...
        afterClose: function(e) {
            this.overlay && !s.coming && this.overlay.fadeOut(e.speedOut, n.proxy(this.close, this)), n("body").unbind("touchmove.fb")
        }
    }, s.helpers.title = {
        defaults: {
            type: "float",
            position: "bottom"
				...
				afterShow: function () {
				    $(".fancybox-title").animate({'opacity': 0}, 300);
				    $(".fancybox-wrap").hover(function () {
				      	$(".fancybox-title").stop(true, true).animate({'opacity': 1}, 300);
				    }, function () {
				      	$(".fancybox-title").stop(true, true).animate({'opacity': 0}, 300);
				    });
